...
import (
	...
	"github.com/nicelizhi/easy-admin/cmd/migrate/migration"
	_ "github.com/nicelizhi/easy-admin/cmd/migrate/migration/version"
	_ "github.com/nicelizhi/easy-admin/cmd/migrate/migration/version-local"
...
var (
	...
	StartCmd  = &cobra.Command{
		...
		Example: "easy-admin migrate -c config/settings.yml",
...
func init() {
	...
	StartCmd.PersistentFlags().BoolVarP(&goAdmin, "goAdmin", "a", false, "generate easy-admin migration file")
